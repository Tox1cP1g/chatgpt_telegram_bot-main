...
PAYMENT_PROVIDER_TOKEN = "381764678:TEST:56567"
...
def main() -> None:
    ...
    application = Application.builder().token("6223384502:AAGT3D4GtMRitsWwfMc865bVJq4GvO_W68Q").build()
