...
⚪ /retry – Переделать ответ на предыдущий вопрос
...
HELP_GROUP_CHAT_MESSAGE = """Ты можешь добавить бота в любой <b>групповой чат</b>, чтобы он помогал его участникам!

Инструкция (посмотри <b>видео</b> ниже):
...
async def start_handle(update: Update, context: CallbackContext):
    ...
    reply_text = "Привет! Я бот-аналог <b>ChatGPT</b>. Задай мне вопрос и мгновенно получи на него ответ! 🤖\n\n"
